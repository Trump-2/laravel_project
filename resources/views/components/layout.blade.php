  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">App</a></h4>

        {{-- blade 語法：【@ auth ... @ else ... @ endauth】在 @ auth ... @ else 之間的內容會在登入成功時顯示，而 @ else ... @ endauth 之間的內容則會再是訪客或未登錄的使用者時會顯示 --}}
        @auth
